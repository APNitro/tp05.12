...
// elesmentHtml.innerHTML = '<p>balise html a insérer dans l\'element html ciblé au préalable</p>'; --> innerHTML pour insérer des balises html
var li = document.getElementById('todoList');
document.querySelector('button').onclick = function() {
        li.innerHTML += '<li>faire les courses</li>' 
}
//    <----- END
